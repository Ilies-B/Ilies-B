...
🎓 Étudiant en **Licence Professionnelle Développement Web & Mobile (LP3 UHA 4.0)** à l'Université de Haute-Alsace. Rentrée septembre 2026<br>
...
- **Web** : JavaScript, Node.js, Express, Socket.io, HTML/CSS, Chart.js, Leaflet
- **Serveur & données** : Docker / Docker Compose, InfluxDB, MQTT (Mosquitto), ChirpStack, Linux
- **Embarqué** : C/C++ (Arduino / PlatformIO), ESP32, ESP32-CAM, Raspberry Pi, LoRaWAN
- **Sécurité** : TLS (HTTPS, MQTTS), certificats X.509, bonnes pratiques de gestion des secrets
...
- 💼 [LinkedIn](https://www.linkedin.com/in/ilies-boussaboua-056ab2340)
- ✉️ bouss.ilies@gmail.com
